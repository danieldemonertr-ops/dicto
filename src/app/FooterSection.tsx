  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-6 flex flex-col items-center gap-8">
        ...
        <Link
          href="/"
          aria-label="Dicto — página inicial"
        ...
        {/* Tagline */}
        <p className="text-sm text-center max-w-sm" style={{ color: "#9CA3AF" }}>
        ...
        <nav className="flex flex-wrap justify-center gap-x-8 gap-y-3">
          {NAV_LINKS.map((link, i) => (
            <Link
              key={i}
              href={link.href}
              className="text-sm transition-colors duration-150 hover:text-gray-900"
              style={{ color: "#6B7280" }}
            >
              {link.title}
            </Link>
        ...
        {/* Divider */}
        <div className="w-full" style={{ borderTop: "1px solid #ebebea" }} />
